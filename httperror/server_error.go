...
func NewInternalServerErrorError(err error) *HTTPError {
...
func NewBadGatewayError(err error) *HTTPError {
...
func NewServiceUnavailableError(err error) *HTTPError {
...
func NewGatewayTimeoutError(err error) *HTTPError {
...
func NewHTTPVersionNotSupportedError(err error) *HTTPError {
...
func NewVariantAlsoNegotiatesError(err error) *HTTPError {
...
func NewInsufficientStorageError(err error) *HTTPError {
...
func NewLoopDetectedError(err error) *HTTPError {
	return NewError(http.StatusLoopDetected, err)
}

// 510 Not Extended
//
// See more: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/510
func NewNotExtendedError(err error) *HTTPError {
	return NewError(http.StatusNotExtended, err)
}

// 511 Network Authentication Required
//
// See more: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/511
func NewNetworkAuthenticationRequiredError(err error) *HTTPError {
